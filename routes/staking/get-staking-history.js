...
router.get('/:stakingTransactionID',async function(req, res, next) {
    ...
    for (let i = 1; i <= staking_roi_per_page; i++) {
        ...
        let interest_info = {
            ...
            staking_roi_accumulation_interval_paid_at: timestamp_interval_values[staking_roi_payment_interval].name+ " " + interval_count, // Increment the interval counter
