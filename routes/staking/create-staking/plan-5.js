...
router.post('/', async function(req, res, next) {
    try {
        ...
        const coreStakingValidation = validateCoreStakingParameters(wallet_id, staking_amount, planData, MODULE1_STAKING_PLAN_5_NAME);
        ...
        // Add Plan 5 specific meta fields
