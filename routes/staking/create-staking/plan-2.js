...
// Plan 2 name constant
const MODULE1_STAKING_PLAN_2_NAME = process.env.MODULE1_STAKING_PLAN_2_NAME || 'Plan B : Standard Staking';
...
router.post('/', async function(req, res, next) {
    try {
        ...
        // Add Plan 2 specific meta fields (standard behavior)
