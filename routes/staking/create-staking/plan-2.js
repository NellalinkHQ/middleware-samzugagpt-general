...
const MODULE1_STAKING_PLAN_2_ALLOWED_STAKING_WALLET_ID = process.env.MODULE1_STAKING_PLAN_2_ALLOWED_STAKING_WALLET_ID;
...
router.post('/', async function(req, res, next) {
    try {
        ...
        const staking_plan_name = MODULE1_STAKING_PLAN_2_NAME;
        ...
        const coreStakingValidation = validateCoreStakingParameters(wallet_id, staking_amount, planData, MODULE1_STAKING_PLAN_2_NAME);
