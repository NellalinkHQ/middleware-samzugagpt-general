...
// Environment variables for Plan 3
...
// Plan 3 specific environment variables
...
// Plan 3 name constant
const MODULE1_STAKING_PLAN_3_NAME = process.env.MODULE1_STAKING_PLAN_3_NAME || 'Plan C : Flexible Staking';
...
router.post('/', async function(req, res, next) {
    try {
        ...
        const staking_plan_id = "plan_3";
        const staking_plan_name = MODULE1_STAKING_PLAN_3_NAME;
        ...
        const coreStakingValidation = validateCoreStakingParameters(wallet_id, staking_amount, planData, MODULE1_STAKING_PLAN_3_NAME);
        if (coreStakingValidation.error) {
            return res.status(400).send(coreStakingValidation.error);
        }

        // Plan 3 specific parameters
        ...
        const staking_capital_locked_duration = MODULE1_STAKING_PLAN_3_CAPITAL_DURATION; 
        ...
        const roi_payment_pattern = MODULE1_STAKING_PLAN_3_ROI_PAYMENT_PATTERN;
        ...
        // Add Plan 3 specific meta fields (advanced behavior)
