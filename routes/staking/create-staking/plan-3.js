...
router.post('/', async function(req, res, next) {
    try {
        ...
        // Plan 3 Configuration (Flexible Staking)
        const staking_plan_id = "plan_3";
        const staking_plan_name = "Plan C: Flexible Staking";
        ...
        const debitRequestBody = {
            ...
            "wallet_id": wallet_id,
            "note": "Plan 3 Staking Request - Flexible Staking",
            "meta_data": {
        ...
        const creditRequestBody = {
            ...
            "note": "Plan 3 Staking Locked - Flexible Staking",
            "meta_data": {
        ...
        const response = {
            status: true,
            status_code: 200,
            message: "Plan 3 Flexible Staking Process Completed Successfully",
            data: {
                staking_plan_id: staking_plan_id,
                staking_plan_name: staking_plan_name,
                staking_amount: staking_amount,
