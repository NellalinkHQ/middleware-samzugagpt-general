...
router.put('/', async function(req, res, next) {
    try {
        ...
        const balanceCheckMiddleware = userWalletBalanceCheck(MODULE1_BASE_URL, MODULE1_BASE_API_KEY, userBearerJWToken, user_id, wallet_id_from, swap_quantity_to_add);
